    ...
    try {
      ...
      if (
        ...
        setError({
          ...
          message:
            "Your Firebase project is blocking this request. You must authorize this specific web identity in your Firebase console.",
        ...
        setError({
          ...
          message:
            "Google Sign-in needs to be enabled in your Firebase Authentication settings.",
          domain: extractedDomain,
        });
      } else {
        setError({
          ...
          message:
            errorMessage ||
            "An unexpected error occurred. Check your connection or configuration.",
          domain: extractedDomain,
        });
      }
    } finally {
      ...
      <div className="hidden md:flex md:w-5/12 bg-indigo-600 dark:bg-indigo-900 items-center justify-center p-12 text-white relative overflow-hidden">
        ...
        <div className="max-w-md space-y-8 relative z-10">
          ...
          <p className="text-indigo-100 text-lg font-light leading-relaxed">
            A premium, AI-driven task environment built for modern teams and
            individuals.
          </p>
        </div>
      </div>
                ...
                {error.domain && (
                  <div className="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <div className="text-[11px] text-slate-500 dark:text-slate-400 bg-indigo-50/50 dark:bg-indigo-900/10 p-4 rounded-xl border border-indigo-100 dark:border-indigo-900/20 leading-relaxed">
                      ...
                      <strong>Authorized Domains</strong> and add the text
                      copied above.
                    </div>
                  </div>
                )}
